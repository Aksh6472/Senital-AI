...
from backend.services.auth_service.app.api.routes import router as auth_router
...
app = FastAPI(
    title="Sentinel AI - Auth Service",
...
if __name__ == "__main__":
    uvicorn.run("backend.services.auth_service.main:app", host="0.0.0.0", port=8001, reload=True)
